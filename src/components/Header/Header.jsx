    ...
    <header>
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 shadow-md">
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto">
          ...
          {/* Log In and Get Started buttons - Right Aligned on Large Screens */}
          ...
          >
            <ul className="flex flex-col mt-4 space-y-2 lg:flex-row lg:space-y-0 lg:space-x-8 lg:mt-0 font-medium">
              <li>
                <NavLink
                  to="/"
                  className={({ isActive }) =>
